		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left">
					<ul><%String username = (String)session.getAttribute("username"); %>
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				<center>
					<h4>ERROR!</h4>
					Make sure your <strong>username</strong> or <strong>password</strong><br> are both correct. 
					<div class="register-home"><a href="login.jsp">Back to Login Page<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></div>
				</center>
			</div>
		</div>
	</div>
