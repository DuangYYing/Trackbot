	...
	<div class="breadcrumbs">
		<div class="container">
			<ol class="breadcrumb breadcrumb1">
				...
				<li class="active">ErrorRegister</li>
			</ol>
		</div>
	</div>
	<!-- //breadcrumbs -->
	...
	<div class="register">
		<div class="container">
			...
			<div class="login-form-grids">
				<center>
					<h4>ERROR!</h4>
					The <strong>username</strong> has already been registered, <br>please change it and try again. 
					<div class="register-home"><a href="register.jsp">Back to Register Page<span class="glyphicon glyphicon-menu-right" aria-hidden="true"></span></a></div>
				</center>
			</div>
		</div>
	</div>
